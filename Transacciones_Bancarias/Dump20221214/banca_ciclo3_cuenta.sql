...
CREATE TABLE `cuenta` (
  ...
  KEY `cuenta_id_cliente_fk` (`id_cliente`),
...
INSERT INTO `cuenta` VALUES ('01-01','2021-06-10',100000,'1'),('02-02','2022-05-15',500000,'1'),('03-03','2022-01-25',750000,'2');
...
-- Dump completed on 2022-12-14 18:05:05
